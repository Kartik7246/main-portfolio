...
const team = [
  {
    ...
    bio: 'Interface design, design systems and prototyping in Figma. Makes the specs developers actually enjoy implementing.',
    initials: 'NA',
    bg: '#1a1510',
    accent: '#c9a96e',
  },
  {
    ...
    bio: 'Node.js, Postgres and distributed systems. Owns the infrastructure that keeps everything boringly reliable.',
    initials: 'JV',
    bg: '#0d1520',
    accent: '#4a9eff',
  },
  {
    ...
    bio: 'Flutter specialist. Has shipped to both App Store and Play Store more times than she can count.',
    initials: 'PR',
    bg: '#0d1a12',
    accent: '#4ade80',
  },
  {
    ...
    bio: 'Turns ambiguous briefs into roadmaps engineering can ship. Keeps the studio honest about outcomes.',
    initials: 'EM',
    bg: '#1a0d1a',
    accent: '#c084fc',
  },
